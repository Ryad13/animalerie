    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if nouveau_lieu.disponibilite=="libre" and nouveau_lieu.id_equip=="mangeoire" and animal.etat=='affame':
                ...
                nouveau_lieu.save()
                messages.add_message(request, messages.SUCCESS, 'Votre animal a été déplacé dans la mangeoire.')
                ...
                nouveau_lieu.disponibilite = "occupe"
                nouveau_lieu.save()
                messages.add_message(request, messages.SUCCESS, 'Votre animal a été déplacé dans la roue.')
                ...
                nouveau_lieu.disponibilite = "occupe"
                nouveau_lieu.save()
                messages.add_message(request, messages.SUCCESS, 'Votre animal a été déplacé dans le nid.')
                ...
                nouveau_lieu.save()
                messages.add_message(request, messages.SUCCESS, 'Votre animal a été déplacé dans la litière.')
            elif nouveau_lieu==ancien_lieu:
                messages.add_message(request, messages.WARNING, 'Votre animal est déjà ici !')
            else :
                print('message')
                messages.add_message(request, messages.ERROR, 'Malheureusement, vous ne pouvez pas déplacer cet animal à cet endroit.')
